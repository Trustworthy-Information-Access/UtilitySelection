...
dataset_path="/root/paddlejob/workspace/env_run/output/sigir-ap/marco-train-100k.jsonl"
output_dir="/root/paddlejob/workspace/env_run/output/sigir-ap/annotation_relevance_ranking.jsonl"
