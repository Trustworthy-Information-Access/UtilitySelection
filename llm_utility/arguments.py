...
class DataArguments:
    ...
    thinking: bool = field(
        default=False, metadata={"help": "whether to add reasoning"}
    )
    nw_knowledge: bool = field(
        default=False, metadata={"help": "answer the question based on internal knowledge"}
    )
    type_prompt: str = field(
        default='', metadata={"help": "prompt type"}
    )
